# This script verifies the header row in each sheet of the NGI_MEDICAL_KB_CORE_V1 Excel workbook.
...
for sheet, expected_header in headers.items():
    ws = wb[sheet]
    actual_header = [cell.value for cell in ws[1]]
    print(f"{sheet}: {actual_header}")
print("Workbook header verification complete.")
